<?php
	...
	$sql = "INSERT INTO usuarios (idUsuario, email, password, domicilio, nombreApellido, nroTarjeta, telefono, fechaRegistro) VALUES  (NULL,'".$email."','".$pass."','".$dom."','".$nom."','".$nroTarj."', '".$nroTel."', NOW())";
