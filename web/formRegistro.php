...
<div class="registro">
	...
	<input required="required" type="text" id="email" name="email" placeholder="Correo Electronico"><img src="imagenes/ayuda.png"  Title="* Ingrese un correo electronico" ><span class="oblig">*</span><div id="Info"></div><br>
	<input required="required" id="pass" type="password" maxlength="12" name="pass" placeholder="Contrase&ntilde;a"><img src="imagenes/ayuda.png"  Title="* La contraseña debe tener un minimo de 6 caracteres" ><span class="oblig">*</span><div id="Info4"></div><br>
